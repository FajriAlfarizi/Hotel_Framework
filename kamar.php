...
<head>
  ...
  <title>Ngeru Hotel & Restaurant</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        <a href="assets/index3.html" class="navbar-brand">
          ...
          <span class="brand-text font-weight-light">Aplikasi Booking Hotel</span>
        </a>
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        <div class="container">
          <?php
          $query = "SELECT * FROM fasilitas_kamar ORDER BY id_kamar ASC";
